  ...
  return (
    <TooltipProvider>
      <motion.header
        ...
        className="fixed top-0 inset-x-0 z-50 flex h-14 items-center justify-between px-3.5 sm:px-12 md:px-24 lg:px-36 bg-white/70 backdrop-blur-xl border-b border-neutral-200/60 dark:bg-neutral-950/70 dark:border-white/10"
      >
        {/* Logo */}
        <Link
          href={`/${locale}`}

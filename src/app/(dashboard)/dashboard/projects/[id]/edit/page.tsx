          ...
          <div className="flex justify-end gap-3">
            {loading ? (
              ...
              <>
                ...
                <Button type="submit" disabled={isSubmitting || !isValid || (!isDirty && !hasImageChanges)} className="bg-neutral-900 hover:bg-neutral-800 active:bg-neutral-800 text-white dark:bg-white dark:hover:bg-neutral-200 dark:active:bg-neutral-200 dark:text-neutral-900 gap-1.5 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed">
                  {isSubmitting ? (
